...
$user = $_SESSION['user'];
$name = $_GET['name'];
$dir1 = "/database/$user/elb/$name/";
$files1 = scandir($dir1);
$size1=sizeof($files1);

$dir = "/database/$user/instance/";
$files = scandir($dir);
                ...
                <form action="/cgi-bin/fe/createelb.py" class="form" role="form" method="post" >
                  <div class="form-group">
                    <strong>
                      ...
                      <?php foreach ($files as $key => $file1) {?>
                      
                      <?php if($key<2)
                                continue;
                       ?> 
                       <?php if(in_array($file1,$files1)){ ?>
                        <input type="checkbox" checked value="<?php echo $file1 ?>" name="<?php echo $file1 ?>">&nbsp&nbsp&nbsp&nbsp<?php echo $file1 ?><br>

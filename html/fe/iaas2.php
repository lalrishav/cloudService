          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form action="/cgi-bin/fe/iaas2.py" class="form" role="form" method="post" >
                  <div class="form-group">
                    <strong>
                    <input class="form-control input-sm" type="text" placeholder="Enter the name" name="os"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-sm" type="text" placeholder="Enter the ram size" name="ram"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-sm" type="text" placeholder="ENter the cpu core" name="cpu"/>
                  </div>
                  <div class="form-group">

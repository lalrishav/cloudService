          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form action="/cgi-bin/fe/launch.py" class="form" role="form" method="post" >
                  <div class="form-group">
                    <strong>
                    <select name="imageId" class="form-control">
                      <option value="ami-6f68cf0f">Red Hat Enterprise Linux 7.3 (HVM), SSD Volume Type</option>
                      <option value="ami-efd0428f">Ubuntu Server 16.04 LTS (HVM), SSD Volume Type</option>
                      <option value="ami-c2c3a2a2">Microsoft Windows Server 2016 Base</option>
                    </select>
                  </div>
                  <div class="form-group">
                    * We have three predefined security group.For user customisation you can add further services manually later
                    <select name="securityGroup" class="form-control">
                      <option value="sg-1991b062">Minimal Services</option>
                      <option value="sg-6798b91c">Intermidiate Services</option>
                      <option value="sg-41be9a3a">Complete Services</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-sm" type="text" placeholder="Enter the number of instances" name="ino"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control" type="text" placeholder="Region:-us-west-2" disabled=""/>
                  </div>
                  <div class="form-group">

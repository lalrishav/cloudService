...
$user = $_SESSION['user'];
$sid = $_GET['sid'];
$size = exec("sudo aws ec2 describe-snapshots --snapshot-id $sid | grep VolumeSize");
echo $size;
$size = explode(",",explode(":",$size)[1])[0];
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form action="/cgi-bin/fe/revertsnap.py" class="form" role="form" method="post" >
                  ...
                  <div class="form-group">
                    <input class="form-control input-sm" type="number" placeholder="Enter the size in GB" name="size" value="<?php echo (int)$size ?>" />
                  </div>
                  <div class="form-group">

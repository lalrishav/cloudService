          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form action="/cgi-bin/fe/createebs.py" class="form" role="form" method="post" >
                  ...
                  <div class="form-group">
                    <input class="form-control input-sm" type="text" placeholder="Enter the size in GB" name="size"/>
                  </div>
                  <div class="form-group">

    ...
    <main>
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row">
              <form action="/cgi-bin/fe/actionami.py" method="post">
              ...
              <div class="col-sm-12">
                <table class="table table-striped table-border checkout-table">
                  <tbody>
                    ...
                    <?php  
                      $f = fopen("/database/$user/ami/$file",'r');
                      $line = fgets($f);
                      fclose($f);
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <option value="createInstance">Launch Instance</option>
                </select>
                </div>
              </div>
              <div class="col-sm-3">

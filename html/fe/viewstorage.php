<?php
                session_start();
                $user = $_SESSION['user'];
                $dir = "/var/www/html/database/$user/nfs/";
                $files = scandir($dir);
                $size=sizeof($files);

                $dir1 = "/var/www/html/database/$user/cifs/";
                $files1 = scandir($dir1);
                $size1 = sizeof($files1);
    ...
    <main>
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row">
              <form action="/cgi-bin/fe/actionstorage.py" method="post">
                ...
                <table class="table table-striped table-border checkout-table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="/users/<?php echo $user?>/<?php echo explode('.',$file)[0]?>"><h5 class="product-title font-alt"><?php echo explode(".",$file)[0] ?></h5></a>
                      </td>
                      <td class="hidden-xs">
                        <h5 class="product-title font-alt">Active</h5>
                      </td>
                      
                    </tr>
                    <?php } ?>
                    <?php foreach($files1 as $count=>$file1){?>
                    <?php if($count<2) continue; ?>
                    <tr>
                      <td class="hidden-xs"><input type="radio" value="<?php echo $file ?>" name="acton"></td>
                      <td>
                        <a href="/users/<?php echo $user?>/<?php echo explode('.',$file1)[0]?>"><h5 class="product-title font-alt"><?php echo explode(".",$file1)[0] ?></h5></a>
                      </td>
                      <td class="hidden-xs">
                        <h5 class="product-title font-alt">Active</h5>
                      </td>
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <option value="extendsize">Extend Size</option>
                  <option value="download">Download .sh File</option>
                </select>
                </div>
              </div>
              <div class="col-sm-3">

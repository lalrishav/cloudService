    ...
    <main>
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row">
              <form action="/cgi-bin/fe/actionsnapshot.py" method="post">
              ...
              <div class="col-sm-12">
                <table class="table table-striped table-border checkout-table">
                  <tbody>
                    ...
                    <?php  
                      $f = fopen("/database/$user/snapshots/$file",'r');
                      $line = fgets($f);
                      fclose($f);
                    ...
                    <tr>
                      ...
                      <td>
                        <h5 class="product-title font-alt"><?php echo $line;?></h5>
                      </td>
                      <td>
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <option value="createVolume">Create Volume</option>
                </select>
                </div>
              </div>
              <div class="col-sm-3">

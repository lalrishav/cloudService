          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <form action="/cgi-bin/fe/attachbs.py" class="form" role="form" method="post" >
                  <div class="form-group">
                    ...
                    <select name="vid" class="form-control">
                      ...
                      <?php  
                        $zone1 = exec("sudo aws ec2 describe-volumes --volume-id $file | grep Zone");
                      ...
                      <option value=<?php echo $file ?>><?php echo $file."-->".$zone1 ?></option>
                      <?php } ?>
                  ...
                  <div class="form-group">
                    <strong>
                    <select name="amiId" class="form-control">
                      <option value="none">-------------------------------------------------------Select Instance-------------------------------------------------</option>
                      ...
                      <option value=<?php echo $file1 ?>><?php echo $file1."-->".$zone?></option>
                      <?php } ?>
                      
                    </select>
                  </div>
                  <div class="form-group">
                    <input type="submit" value="Attach Volume" class="form-control">
                  </div>
